...
using System.Text;
using HotelSupervisorClient.Enums;
...
namespace HotelSupervisorClient.Managers
{
    internal static class ReflectionManager
    {
        ...
        static ReflectionManager()
        {
            ...
            string[] strs = Process.GetCurrentProcess().MainModule.FileName.Split('\\');
            string processName = strs[strs.Length - 1];
            dllName = processName.Replace("vshost.", string.Empty);
