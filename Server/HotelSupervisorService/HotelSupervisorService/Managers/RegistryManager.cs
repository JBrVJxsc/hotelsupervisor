...
namespace HotelSupervisorService.Managers
{
    ...
    internal class RegistryManager
    {
        ...
        public RegistryManager(string subKey, RegDomain regDomain)
        {
            ///设置注册表项名称
            _subkey = subKey;
            ///设置注册表基项域
        ...
        public static string Get64BitRegistryKeyValueFromLocalMachine(string subKey, string valueName)
        {
            RegistryKey key = OpenSubKey(Registry.LocalMachine, subKey, false,
